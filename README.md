...
<table align="center">
  ...
  <tbody>
    ...
    <tr>
      <td>微信公众号（订阅号 / 服务号）</td>
      <td align="center">⚠️ 开发中</td>
      <td align="center">中等</td>
      <td><a href="doc/guides/wechat-mp/doc/开发计划.md">微信公众号接入计划</a></td>
    </tr>
    <tr>
      <td>飞书（停止维护）</td>
      <td align="center">✅ 可用</td>
...
| 私聊 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 群聊 | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ |
| 多账户 | ✅ | -  | ✅ | ✅ | ✅ | ⚠️<br />开发中 | ⚠️<br />schema 已预留 |
| 主动发送消息<br />（定时任务） | ✅ | ✅ | ✅ | ✅ | ✅（文本、图片、Markdown） | ⚠️<br />开发中 | ⚠️<br />skeleton 已实现 |
